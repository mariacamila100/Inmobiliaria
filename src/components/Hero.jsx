  ...
  return (
    <div className="relative h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 w-full max-w-5xl -mt-10">
        ...
        <p className="text-slate-200 text-lg md:text-xl font-medium mb-10 max-w-2xl mx-auto leading-relaxed opacity-90">
          La plataforma integral para vivir, invertir y conectar con tu comunidad en Santander.
        </p>
        
        {/* Buscador: Ultra Redondeado y Limpio */}
        <div className="bg-white rounded-full p-2 max-w-2xl mx-auto flex items-center shadow-2xl border border-white/20">
